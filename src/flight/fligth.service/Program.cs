...
using fligth.service.Services;
using Microsoft.Extensions.Configuration;
using System;
using System.IO;

namespace fligth.service
{
    class Program
    {
        //private static ArrayList myEventsAsConsumer = new ArrayList() { "HotelRequestSucceedEvent", "PaymentRequestFailedEvent" };
        ...
        static void Main(string[] args)
        {
            ...
            FlightEventConsumerService consumerService = new FlightEventConsumerService(conf, consumer_subscribe, consumer_groupid);
